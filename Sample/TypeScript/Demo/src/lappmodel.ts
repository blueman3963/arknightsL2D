    ...
    private setupModel(setting: ICubismModelSetting): void
    {
        ...
        let setupEyeBlink = () =>
        {
            if(this._modelSetting.getEyeBlinkParameterCount() > 0)
            {
                ...
                this._eyeBlink.setBlinkingInterval(6);
                this._eyeBlink.setBlinkingSetting(0.2, 0.1, 0.3);
        ...
        let setupBreath = () =>
        {
            ...
            breathParameters.pushBack(new BreathParameterData(this._idParamBreath, 0.0, 1.0, 6.5345, 0.8));
            ...
            breathParameters.pushBack(new BreathParameterData(this._idParamBodyAngleX, 0.0, 10.0, 15.5345, 0.5));
